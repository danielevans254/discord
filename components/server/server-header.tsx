  ...
  return (
    <ScrollArea className="flex-1 w-full">
      <DropdownMenu >
        ...
        <DropdownMenuContent className="w-56 text-sm text-black dark:text-neutral-100 space-y-[2px] overflow-y-auto max-h-[00px]">
          ...
          <div className="flex flex-col px-3 py-2 space-y-2">
            ...
            {isAdmin && (
              <button className="w-full text-left hover:bg-zinc-700/10 dark:hover:bg-zinc-700/50 transition rounded-md px-2 py-1 text-red-700/90 dark:text-red-700/80">
                Manage Stickers
              </button>
            )}
          </div>
